    ...
    <>
      <nav className={`navbar navbar-expand-lg navbar-dark-${props.mode}`}>
        <div className="container-fluid">
          <Link className={`navbar-brand text-${props.mode!=='light'?'light':'dark'}`} to="/">{props.title}</Link>
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              <li className="nav-item">
                <Link className={`nav-link active text-${props.mode!=='light'?'light':'dark'}`} aria-current="page" to="/">Home</Link>
                {/* <a className="nav-link active" aria-current="page" href="#">Home</a> */}
              </li>
              <li className="nav-item">
                <Link className={`nav-link text-${props.mode!=='light'?'light':'dark'}`} to="/about">{props.aboutText}</Link>
              </li>
            </ul>
          </div>
        ...
        <p className={`text-${props.mode!=='light'?'light':'dark'}`}>Change theme</p>
      </nav>
    </>
  );
}
